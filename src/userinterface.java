...
public class userinterface extends JFrame {
	...
	private static final int PORT=JoinGroup.port1;
	...
	public userinterface() throws IOException {
		...
		lbl_username.setText(JoinGroup.GroupName.toUpperCase());
		...
		send.addActionListener(new ActionListener() {
			...
			try {
				...
				String query1= "INSERT INTO chathistory (Sender, Chat, Time, GroupName)"+ "VALUES ('"+login.usernamecall+"','"+msgfromclient+"','"+currentTime+"','"+JoinGroup.GroupName+"')";
